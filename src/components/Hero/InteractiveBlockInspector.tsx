...
export const InteractiveBlockInspector: React.FC = () => {
  ...
  return (
    <div className="relative group w-full rounded-2xl bg-white/[0.03] backdrop-blur-md border border-white/[0.08] p-5 sm:p-6 text-slate-200 transition-all duration-300 hover:border-cyan-500/30">
      ...
      <div className="p-1 bg-black/50 backdrop-blur-md border border-white/[0.08] rounded-xl flex items-center gap-1.5 mb-4">
        <button
      ...
      <div className="min-h-[385px] flex flex-col justify-between py-2 transition-all duration-200">
        ...
        {activeTab === 'bytestream' && (
          <div className="space-y-3 font-sans text-xs">
            ...
            <div className="p-3.5 rounded-lg bg-black/40 border border-white/[0.06] text-[11px] lg:text-xs text-slate-300 leading-relaxed break-all select-all font-mono tracking-normal">
              {rawHeaderBytes}
            </div>
              ...
              return (
                <>
                  ...
                  <div className="space-y-3.5 mt-3.5">
                    {/* TxID */}
                    <div>
                      <span className="text-[11px] font-sans font-medium text-slate-400 uppercase tracking-wider mb-1 block">
                    ...
                    <div className="space-y-2">
                      <div>
                        ...
                        {isCoinbase ? (
                          <div className="font-mono text-xs text-purple-300/90 bg-purple-950/20 border border-purple-500/20 p-2.5 rounded-lg flex items-center justify-between">
                            <span>{isVi ? 'Không có (Giao thức đúc mới)' : 'None (Minted by Protocol)'}</span>
                            <span className="text-[10px] text-slate-500 font-sans">No Input / UTXO</span>
                          </div>
                        ) : (
                    ...
                    <div>
                      <label className="text-[11px] font-sans font-medium text-slate-400 uppercase tracking-wider mb-1 block">
                        {isVi ? 'Số lượng Bitcoin' : 'Bitcoin Amount'}
                      </label>
