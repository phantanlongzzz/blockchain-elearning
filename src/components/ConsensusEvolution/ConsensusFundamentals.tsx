...
export const ConsensusFundamentals: React.FC<ConsensusFundamentalsProps> = ({
                ...
                >
                  ...
                  <div className="grid grid-cols-2 p-0.5 rounded-md bg-[#080C10] border border-slate-800 text-xs">
                    ...
                    <button
                      ...
                      className={`py-1 px-2 rounded text-[11px] font-medium transition-colors cursor-pointer ${
                        !isAttack
                          ? 'bg-white/[0.06] border border-border-primary text-text-primary'
                          : 'text-slate-400 hover:text-slate-200'
                      }`}
                    >
 ...
 className="self-start sm:self-auto px-3.5 py-1.5 rounded-lg bg-text-primary hover:bg-white/90 text-bg-primary font-semibold font-medium text-xs transition-colors cursor-pointer disabled:opacity-50"
                >
                  {isResolving
                    ? isVi
                      ? 'Đang xử lý...'
      ...
      {onNextStage && (
        <div className="flex items-center justify-end pt-2">
          <button
            type="button"
            onClick={onNextStage}
 className="px-5 py-2 rounded-lg bg-text-primary hover:bg-white/90 text-bg-primary font-semibold font-medium text-xs flex items-center gap-2 transition-all cursor-pointer"
          >
