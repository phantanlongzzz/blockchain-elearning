        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#090A0F] border border-[#1C2430] rounded-lg px-3 py-2 text-xs font-mono text-[#00C98D] font-medium focus:outline-none focus:border-[rgba(0,201,141,0.5)] transition-colors"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full py-2 mt-2 rounded-lg bg-[#00C98D] hover:bg-[#00B982] text-[#090A0F] font-semibold text-xs font-sans transition-colors flex items-center justify-center gap-1.5 cursor-pointer shadow-sm"
          >
              ...
              return (
                <div
                  ...
                  className={`group px-3 py-2.5 rounded-lg border transition-all duration-150 cursor-pointer flex flex-col gap-2 ${
                    isSelected
                      ? 'bg-[#0F131A] border-[#00C98D] text-[#F2F4F7]'
                      : isTampered
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <span
                        className={`font-mono text-[11px] font-medium ${
                          isTampered ? 'text-rose-400' : 'text-[#00C98D]'
                        }`}
                      >
                  ...
                  <div className="flex items-center justify-between gap-2 pt-1 border-t border-[#1C2430]/60 text-[11px]">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      ...
                      <button
                        ...
                        className="px-2 py-1 rounded bg-[#0F131A] hover:bg-[#11161E] text-[#00C98D] border border-[#1C2430] text-[10px] font-sans font-medium transition-colors cursor-pointer"
                      >
                        <span>Kiểm tra</span>
                      </button>
