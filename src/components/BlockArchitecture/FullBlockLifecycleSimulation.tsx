  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="p-6 sm:p-7 rounded-2xl bg-[#0B0F19]/70 border border-white/[0.08] space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-white/[0.06]">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-4 py-1.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 disabled:opacity-40 text-white font-semibold text-xs flex items-center gap-1.5 transition-all cursor-pointer font-sans"
            >
        ...
        <div className="p-4 rounded-xl bg-black/40 border border-white/[0.05] flex items-start gap-3">
          <div className="w-8 h-8 rounded-lg bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-center text-cyan-300 font-semibold font-mono shrink-0 text-xs">
            {currentStep}
          </div>
        ...
        <div className="p-6 rounded-xl bg-black/40 border border-white/[0.06] min-h-[280px] flex flex-col justify-center">
          {/* STEP 1: CREATE TRANSACTION */}
          {currentStep === 1 && (
            <div className="max-w-md mx-auto w-full space-y-4 text-center">
              <div className="p-5 rounded-xl bg-[#0B0F19]/80 border border-cyan-500/30 space-y-3">
          ...
          {currentStep === 2 && (
            <div className="max-w-xl mx-auto w-full space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 font-mono text-xs text-center">
                ...
                <div className="p-3.5 rounded-xl bg-[#0B0F19]/80 border border-cyan-500/40 space-y-1">
          ...
          {currentStep === 3 && (
            <div className="max-w-lg mx-auto w-full space-y-4 text-center">
              <div className="p-5 rounded-xl bg-[#0B0F19]/80 border border-cyan-500/40 space-y-3">
          ...
          {currentStep === 5 && (
            <div className="max-w-xl mx-auto w-full space-y-3 font-mono text-xs text-center">
              ...
              <div className="p-5 rounded-xl bg-[#0B0F19]/80 border border-cyan-500/30 space-y-2">
          ...
          {currentStep === 6 && (
            <div className="max-w-2xl mx-auto w-full space-y-4 font-mono text-xs">
              <div className="p-5 rounded-xl bg-[#0B0F19]/80 border border-cyan-500/40 space-y-4">
        ...
        <div className="p-6 rounded-xl bg-black/40 border border-white/[0.06] space-y-3">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            {onOpenHandsOnLab && (
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-semibold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer shrink-0 font-sans"
              >
