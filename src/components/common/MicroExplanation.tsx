...
export const MicroExplanation: React.FC<MicroExplanationProps> = ({
  ...
  return (
    <span className={`relative inline-flex items-center gap-1 font-mono ${className}`}>
      <span className="font-bold text-teach-1 border-b border-dashed border-teach-1/60 cursor-help">
        {term}
      </span>
      <button
        type="button"
        ...
        className="inline-flex items-center text-text-muted hover:text-text-primary transition-all cursor-pointer p-0.5"
