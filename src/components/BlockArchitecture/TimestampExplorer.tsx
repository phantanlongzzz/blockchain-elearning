        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div
            className={`p-4 rounded-lg border transition-all space-y-2.5 ${
              isTimeChanged
                ? 'bg-[#10151D] border-border-primary ring-1 ring-white/10'
                : 'bg-[#10151D] border-border-primary'
            }`}
          >
            <div className="flex items-center justify-between text-xs font-mono">
              <span className="font-semibold text-text-primary">Block #102</span>
              <span className="px-2 py-0.5 rounded bg-white/[0.06] text-text-secondary border border-border-primary text-[10px] font-semibold font-sans">
            ...
            <div
              className={`p-2.5 rounded-md border font-mono text-xs space-y-1 ${
                isTimeChanged
                  ? 'bg-white/[0.04] border-border-secondary text-text-primary'
            ...
            >
              <div className="font-medium flex items-center gap-1.5">
                ...
                {isTimeChanged && (
                  <span className="text-[10px] text-text-secondary font-semibold font-sans ml-auto">
            ...
            <div className="text-[11px] font-mono truncate text-text-secondary">
        ...
        <div className="p-4 sm:p-5 rounded-lg bg-[#10151D] border border-[#1C2430] space-y-4">
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            <button
              ...
              className="px-3 py-1.5 rounded-md bg-white/[0.04] hover:bg-white/[0.08] text-text-primary border border-border-primary text-xs font-mono font-semibold cursor-pointer"
            >
              +1s
            </button>
            <button
